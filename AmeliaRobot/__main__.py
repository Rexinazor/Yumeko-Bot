...
PM_START_TEXT = """
Hey {}, my name is [Yumeko](https://telegra.ph/file/53a8d858f6e83debec3ce.jpg)!
...
HELP_STRINGS = """
`Heya, Am Yumeko [🙋‍♀️](https://telegra.ph/file/53a8d858f6e83debec3ce.jpg)
`An Group Management Bot with advanced features, click on below buttons for details of each module`"""

amelia_IMG = "https://telegra.ph/file/53a8d858f6e83debec3ce.jpg"
...
def amelia_about_callback(update, context):
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm Yumeko, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about amelia, let us know at @BHZBot_Support.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yeah I'm alive ")
        except Unauthorized:
            LOGGER.warning(
